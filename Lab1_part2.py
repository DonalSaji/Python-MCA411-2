...
Demonstrates:
- Nested lists, tuples, sets and dictionaries
- Set operations
...
cattle_records = [
    {
        ...
        "breed": "Holstein",
        "sex": "Female",
        "measurements": (36.1, 78.5, 95.2),  # birth, 3-month, 12-month weight
        "health_score": 8,
...
# Tuple containing fixed farm information
farm_info = ("Dairy Farm", "Bengaluru", "Karnataka")

# Set containing available ration categories
